...
public class RedeemScriptParserFactoryTest {
    ...
    @Test
    public void get_withP2wshP2shCustomErpRedeemScript_shouldReturnRedeemScriptParser() {
        Script redeemScript = RedeemScriptUtils.createP2shP2wshErpCustomRedeemScript(
            defaultRedeemScriptKeys,
            emergencyRedeemScriptKeys,
            CSV_VALUE
        );
        ...
        Assert.assertTrue(redeemScriptParser instanceof P2shP2wshErpCustomRedeemScriptParser);
    }
