...
public class LegacyAddressTest {
    ...
    public void p2shAddressCreationFromKeys() throws Exception {
        ...
        BtcECKey key1 = DumpedPrivateKey.fromBase58(MAINNET, "5JaTXbAUmfPYZFRwrYaALK48fN6sFJp4rHqq2QSXs8ucfpE4yQU").getKey();
        key1 = BtcECKey.fromPrivate(key1.getPrivKeyBytes());
        BtcECKey key2 = DumpedPrivateKey.fromBase58(MAINNET, "5Jb7fCeh1Wtm4yBBg3q3XbT6B525i17kVhy3vMC9AqfR6FH2qGk").getKey();
        key2 = BtcECKey.fromPrivate(key2.getPrivKeyBytes());
        BtcECKey key3 = DumpedPrivateKey.fromBase58(MAINNET, "5JFjmGo5Fww9p8gvx48qBYDJNAzR9pmH5S389axMtDyPT8ddqmw").getKey();
        key3 = BtcECKey.fromPrivate(key3.getPrivKeyBytes());
