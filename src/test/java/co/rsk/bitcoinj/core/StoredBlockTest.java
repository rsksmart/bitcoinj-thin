...
public class StoredBlockTest {
    ...
    public void deserializeCompact_whenStoringChainWorkInByteBufferOf128bytesCapacity() {
        ...
        assertEquals(StoredBlock.COMPACT_SERIALIZED_SIZE, ba128V1.length);
        assertEquals(StoredBlock.COMPACT_SERIALIZED_SIZE_V2, ba128V2.length);

        StoredBlock deserialized128V1 = StoredBlock.deserializeCompact(mainnet, ByteBuffer.wrap(ba128V1));
        StoredBlock deserialized128V2 = StoredBlock.deserializeCompact(mainnet, ByteBuffer.wrap(ba128V2));
    ...
    public void serializeCompact_whenChainWorkWithDifferentSize() {
        ...
        StoredBlock deserializedV2 = StoredBlock.deserializeCompact(mainnet, ByteBuffer.wrap(baV2));
        StoredBlock deserialized128V1 = StoredBlock.deserializeCompact(mainnet, ByteBuffer.wrap(ba128V1));
        StoredBlock deserialized128V2 = StoredBlock.deserializeCompact(mainnet, ByteBuffer.wrap(ba128V2));
