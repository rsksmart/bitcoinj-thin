...
public class AddressTest {
    ...
    public void testJavaSerialization() throws Exception {
        LegacyAddress testAddress = LegacyAddress.fromBase58(testParams, "n4eA2nbYqErp7H6jebchxAN59DmNpksexv");
        ...
        LegacyAddress mainAddress = LegacyAddress.fromBase58(mainParams, "17kzeh4N8g49GFvdDzSf8PjaPfyoD1MndL");
    ...
    public void equals_withDifferentClass_shouldReturnFalse() {
        ...
        LegacyAddress address = new LegacyAddress(testParams, hash160);
    ...
    public void equals_withDifferentHash_shouldReturnFalse() {
        LegacyAddress address = new LegacyAddress(testParams, HEX.decode("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc"));
        LegacyAddress anotherAddress = new LegacyAddress(testParams, HEX.decode("4a22c3c4cbb31e4d03b15550636762bda0baf85a"));
    ...
    public void hashCode_withEqualAddresses_shouldMatch() {
        LegacyAddress fromHash = new LegacyAddress(testParams, HEX.decode("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc"));
        LegacyAddress fromBase58 = LegacyAddress.fromBase58(testParams, "n4eA2nbYqErp7H6jebchxAN59DmNpksexv");
    ...
    public void constructor_withHashNotTwentyBytes_shouldThrow() {
        assertThrows(IllegalArgumentException.class, () -> new LegacyAddress(testParams, new byte[19]));
        assertThrows(IllegalArgumentException.class, () -> new LegacyAddress(testParams, new byte[21]));
    }
}
