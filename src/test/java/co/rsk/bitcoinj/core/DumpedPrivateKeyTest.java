...
public class DumpedPrivateKeyTest {
    ...
    public void testJavaSerialization() throws Exception {
        ...
        DumpedPrivateKey key = new DumpedPrivateKey(MAINNET, new BtcECKey().getPrivKeyBytes(), true);
    ...
    public void cloning() throws Exception {
        DumpedPrivateKey a = new DumpedPrivateKey(MAINNET, new BtcECKey().getPrivKeyBytes(), true);
