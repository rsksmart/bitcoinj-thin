...
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_0NOTEQUAL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_1;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_10;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_11;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_12;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_13;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_14;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_15;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_16;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_1ADD;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_1NEGATE;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_1SUB;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2DIV;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2DROP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2DUP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2MUL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2OVER;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2ROT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_2SWAP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_3;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_3DUP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_4;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_5;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_6;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_7;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_8;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_9;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_ABS;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_ADD;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_AND;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_BOOLAND;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_BOOLOR;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_CAT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_CHECKLOCKTIMEVERIFY;
...
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_CHECKSIG;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_CHECKSIGVERIFY;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_CODESEPARATOR;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_DEPTH;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_DIV;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_DROP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_DUP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_ELSE;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_ENDIF;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_EQUAL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_EQUALVERIFY;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_FROMALTSTACK;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_GREATERTHAN;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_GREATERTHANOREQUAL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_HASH160;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_HASH256;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_IF;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_IFDUP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_INVALIDOPCODE;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_INVERT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_LEFT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_LESSTHAN;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_LESSTHANOREQUAL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_LSHIFT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_MAX;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_MIN;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_MOD;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_MUL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NEGATE;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NIP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP1;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP10;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP3;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP4;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP5;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP6;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP7;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP8;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOP9;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NOTIF;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NUMEQUAL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NUMEQUALVERIFY;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_NUMNOTEQUAL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_OR;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_OVER;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_PICK;
...
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_RIGHT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_RIPEMD160;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_ROLL;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_ROT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_RSHIFT;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_SHA1;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_SHA256;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_SIZE;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_SUB;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_SUBSTR;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_SWAP;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_TOALTSTACK;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_TUCK;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_VERIF;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_VERIFY;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_VERNOTIF;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_WITHIN;
import static co.rsk.bitcoinj.script.ScriptOpCodes.OP_XOR;
...
public class Script {
    ...
    public int getNumberOfSignaturesRequiredToSpend() {
        if (redeemScriptParser.isFastBridgeMultiSig() || redeemScriptParser.isStandardMultiSig()) {
