 ...
 * {@link #fromHash(NetworkParameters, byte[])} or {@link #fromKey(NetworkParameters, BtcECKey)} to construct a native
 * segwit address.</p>
 */
public class SegwitAddress extends Address {
     ...
     * {@link #fromHash(NetworkParameters, byte[])} or {@link #fromKey(NetworkParameters, BtcECKey)}.
     * 
     * @param params
    ...
    /**
     * Construct a {@link SegwitAddress} that represents the public part of the given {@link BtcECKey}. Note that an
     ...
     * @return constructed address
     */
    public static SegwitAddress fromKey(NetworkParameters params, BtcECKey key) {
