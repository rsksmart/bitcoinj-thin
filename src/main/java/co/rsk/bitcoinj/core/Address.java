...
public abstract class Address extends PrefixedChecksummedBytes {
    ...
    /**
     * Construct an {@link Address} that represents the public part of the given {@link BtcECKey}.
     *
     * @param params
     ...
     * @return constructed address
     */
    public static Address fromKey(final NetworkParameters params, final BtcECKey key, final ScriptType outputScriptType) {
