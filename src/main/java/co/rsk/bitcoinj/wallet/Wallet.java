...
import co.rsk.bitcoinj.core.listeners.*;
import co.rsk.bitcoinj.core.AbstractBlockChain;
import co.rsk.bitcoinj.core.Address;
import co.rsk.bitcoinj.core.BlockChain;
import co.rsk.bitcoinj.core.BloomFilter;
import co.rsk.bitcoinj.core.Coin;
import co.rsk.bitcoinj.core.Context;
import co.rsk.bitcoinj.core.ECKey;
import co.rsk.bitcoinj.core.FilteredBlock;
import co.rsk.bitcoinj.core.InsufficientMoneyException;
import co.rsk.bitcoinj.core.Message;
import co.rsk.bitcoinj.core.NetworkParameters;
import co.rsk.bitcoinj.core.Peer;
import co.rsk.bitcoinj.core.PeerFilterProvider;
import co.rsk.bitcoinj.core.PeerGroup;
import co.rsk.bitcoinj.core.ScriptException;
import co.rsk.bitcoinj.core.Sha256Hash;
import co.rsk.bitcoinj.core.StoredBlock;
import co.rsk.bitcoinj.core.Transaction;
import co.rsk.bitcoinj.core.TransactionBag;
import co.rsk.bitcoinj.core.TransactionBroadcast;
import co.rsk.bitcoinj.core.TransactionBroadcaster;
...
import co.rsk.bitcoinj.wallet.Protos.Wallet.*;
import co.rsk.bitcoinj.wallet.WalletTransaction.*;
import co.rsk.bitcoinj.wallet.listeners.KeyChainEventListener;
import co.rsk.bitcoinj.wallet.listeners.ScriptsChangeEventListener;
import co.rsk.bitcoinj.wallet.listeners.WalletChangeEventListener;
import co.rsk.bitcoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import co.rsk.bitcoinj.wallet.listeners.WalletCoinsSentEventListener;
import co.rsk.bitcoinj.wallet.listeners.WalletEventListener;
import co.rsk.bitcoinj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, co.rsk.bitcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link co.rsk.bitcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link co.rsk.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, co.rsk.bitcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link co.rsk.bitcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link co.rsk.bitcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link co.rsk.bitcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws co.rsk.bitcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(co.rsk.bitcoinj.crypto.KeyCrypter,
     ...
     * {@link co.rsk.bitcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link co.rsk.bitcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link co.rsk.bitcoinj.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable co.rsk.bitcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws co.rsk.bitcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
