...
import co.rsk.bitcoinj.deprecated.core.BtcECKey.MissingPrivateKeyException;
import co.rsk.bitcoinj.deprecated.script.Script;
import co.rsk.bitcoinj.deprecated.script.ScriptChunk;
import co.rsk.bitcoinj.deprecated.wallet.KeyBag;
import co.rsk.bitcoinj.deprecated.wallet.Wallet;
import co.rsk.bitcoinj.deprecated.wallet.Wallet.MissingSigsMode;
...
public class MissingSigResolutionSigner extends StatelessTransactionSigner {
    ...
    public MissingSigsMode missingSigsMode = Wallet.MissingSigsMode.USE_DUMMY_SIG;
