 ...
 *
 * NOTE (PoC): the {@link #checkDifficultyTransitions} logic below is a first port of the BIP-94
 * rules and must be validated against a corpus of real testnet4 headers before production use.
 */
