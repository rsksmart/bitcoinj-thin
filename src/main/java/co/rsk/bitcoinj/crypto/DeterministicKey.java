...
public class DeterministicKey extends BtcECKey {
     ...
     * in which case the time is stored alongside the key as per normal, see {@link co.rsk.bitcoinj.core.BtcECKey#getCreationTimeSeconds()}.
     */
    @Override
    ...
    public void formatKeyWithAddress(boolean includePrivateKeys, StringBuilder builder, NetworkParameters params) {
        final LegacyAddress address = toAddress(params);
